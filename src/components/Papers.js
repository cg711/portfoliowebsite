...
export const Papers = () => {
  return (
    <div className="flex justify-evenly h-48 items-center flex-col w-full mt-4">
            <a href="https://drive.google.com/file/d/1fz2SwaUDYI3PI_gxELmoVAsUxLFgPNF3/view?usp=sharing" target="_blank" className="h-10 mt-4 px-5 text-blue-500 border-2 border-blue-500 rounded-2xl transition-colors duration-150
                        focus:shadow-outline
                        hover:bg-blue-500 hover:text-white sm:mt-0 sm:w-auto mx-2 flex justify-center items-center">
                <div className="flex items-center">
                    <p className="mr-2">Ethics Paper</p>
