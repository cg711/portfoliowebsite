    ...
    return (
        ...
        flex flex-col items-center mt-4" id="experience">
            ...
            <div className="flex items-center justify-around mx-2">
                <button className="border-blue-500 border-4 rounded-full h-min p-2  text-blue-500 transition-colors duration-150 hover:bg-blue-500" onClick={() => setCurrentJob((currentJob === 0) ? childArray.length - 1 : currentJob - 1)}>
                ...
                <button className="border-blue-500 border-4 rounded-full h-min p-2  text-blue-500 transition-colors duration-150 hover:bg-blue-500" onClick={() => setCurrentJob((currentJob + 1) % 4)}>
