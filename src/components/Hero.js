...
export default function Hero() {
  ...
  return (
    ...
    ">
      ...
      <div className="sm:h-screen md:h-screen md:-ml-48 md:-mr-48 w-full">
        <Canvas>
          <ambientLight/>
          <spotLight/>
      ...
      <div className="flex flex-col items-center">
        <div className="max-w-2xl text-center text-white text-2xl md:pr-16 mx-4">
          <h1>Hi! I'm Casey.</h1>
          <p>I'm a {((d2 - d1) * 0.000000000031709).toFixed(2)} year-old sophmore Computer Engineer at Iowa State Univeristy, and I love new challenges.</p>
        </div>
        <Resume/>
      </div>
    </div>
