  ...
  return (
    <div className="font-jose scroll-smooth scroll-py-1">
      ...
      <div className="relative">
        ...
        <ProjectTree>
          <Project projName="OpenCV Vaccum Tracker" id="proj1" img='/opencvlogo.webp' techs="OpenCV, Python" int="/vc.webp">
            <p>
          ...
          <Project projName="Ring Doorbell Clone" id="proj2" img='/pirmotionsensor.webp' techs="Raspberry Pi, Python" int="/pirpic.webp">
            <p>
          ...
          <Project projName="Healing Haiti" id="proj3" img='/healinghaiti.webp' techs="N/A" int="/haiti.webp">
            <p>
          ...
          <Project projName="Microservices Application" id="proj4" img='/microservices.webp' techs="Springboot, MySQL, REST, Java, Spring Libraries" int="microservices.webp">
            <p>
          ...
          <Project projName="FPGA Vault System" int="/vault.webp" img="/fpga.webp" id="proj15" techs="FPGA, Verilog, Quartus Prime">
            <p>
          ...
          <Project projName="MIPS Pipelined Processor" int="/pipelined.webp" img="/mips.webp" id="proj16" techs="VHDL, Questa Sim, FGPA">
            <p>
